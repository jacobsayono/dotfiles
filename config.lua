...
local function edit(cmd)
  ...
  if vim.bo.ft ~= "lir" then
    ...
    vim.api.nvim_feedkeys(keys, "nit", false)
  end
end

lvim.builtin.lir.mappings["<CR>"] = edit
lvim.builtin.lir.mappings["l"] = edit

-- lvim.keys.insert_mode["<C-Space>"] = "<Esc>"
-- lvim.keys.normal_mode["i"] = "k"
-- lvim.keys.normal_mode["k"] = "j"
-- lvim.keys.normal_mode["j"] = "h"
-- lvim.keys.normal_mode["<leader>"] = "i"
-- lvim.keys.normal_mode["<S-leader>"] = "<Esc>"
